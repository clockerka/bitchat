...
class ShareViewController: SLComposeServiceViewController {
    ...
    override func viewDidLoad() {
        ...
        placeholder = NSLocalizedString("Share to bitchat...", comment: "")
        ...
        group.notify(queue: .main) { [weak self] in
            if let url = foundURL {
                ...
                let urlData: [String: String] = [
                    ...
                    "title": pageTitle ?? url.host ?? NSLocalizedString("Shared Link", comment: "")
                ]
    ...
    private func handleSharedImage(_ image: UIImage) {
        ...
        saveToSharedDefaults(content: NSLocalizedString("Image sharing coming soon!", comment: ""), type: "image")
        openMainApp()
    }
    ...
    private func openMainApp() {
        ...
        DispatchQueue.main.async {
            self.textView.text = NSLocalizedString("✓ Shared to bitchat", comment: "")
